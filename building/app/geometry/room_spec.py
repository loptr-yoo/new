...
class SolverConfig:
    ...
    dummy_max_per_island: int = 3
    dummy_max_aspect_ratio: float = 4.0
    dummy_max_facade_shared_length: float = 3.0
    dummy_dynamic_facade_shared_length: Optional[float] = None
    dummy_max_core_shared_length: float = 4.0
    max_layout_retries: int = 5
    macro_void_threshold: float = 1.5
    semantic_residual_abort_ratio: float = 0.15
    semantic_capacity_ratio: float = 0.95
